...
class Employee(db.Model):
    ...
    reviews=db.relationship("Review",back_populates="employees",cascade="all, delete-orphan")
    onboarding=db.relationship("Onboarding",back_populates="employee")
    def __repr__(self):
...
class Review(db.Model):
    ...
    employee_id=db.Column(db.Integer,db.ForeignKey("employees.id"))
    employees=db.relationship("Employee",back_populates="reviews")
    def __repr__(self):
